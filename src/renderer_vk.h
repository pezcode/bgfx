...
// TODO remove
#define BGFX_VK_CONFIG_ALLOCATOR_DEDICATED_ONLY 1

#ifndef BGFX_VK_CONFIG_ALLOCATOR_DEDICATED_ONLY
#	define BGFX_VK_CONFIG_ALLOCATOR_DEDICATED_ONLY 0
#endif // BGFX_VK_CONFIG_ALLOCATOR_DEDICATED_ONLY

#ifndef BGFX_VK_CONFIG_ALLOCATOR_BLOCK_SIZE
#	define BGFX_VK_CONFIG_ALLOCATOR_BLOCK_SIZE (16 << 20)
#endif // BGFX_VK_CONFIG_ALLOCATOR_BLOCK_SIZE

#ifndef BGFX_VK_CONFIG_MAX_DESCRIPTOR_SETS
#	define BGFX_VK_CONFIG_MAX_DESCRIPTOR_SETS (1024 * BGFX_CONFIG_MAX_FRAME_LATENCY)
#endif // BGFX_VK_CONFIG_MAX_DESCRIPTOR_SETS
...
#define VK_IMPORT_DEVICE                                                     \
			...
			VK_IMPORT_DEVICE_FUNC(true,  vkGetBufferMemoryRequirements2KHR); \
			VK_IMPORT_DEVICE_FUNC(true,  vkGetImageMemoryRequirements2KHR);  \
			/* VK_KHR_swapchain */                                           \
